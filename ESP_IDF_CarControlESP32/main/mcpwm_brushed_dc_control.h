...
#define MOTOR_LEFT_FWD_PIN 33//25   //Set GPIO 15 as PWM0A
#define MOTOR_LEFT_REV_PIN 25//26   //Set GPIO 16 as PWM0B
#define MOTOR_RIGHT_FWD_PIN 26//27   //Set GPIO 15 as PWM0A
#define MOTOR_RIGHT_REV_PIN 27//14   //Set GPIO 16 as PWM0B
