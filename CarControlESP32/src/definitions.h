...
#define LEDC_CHANNEL_LEFT_BACK   LEDC_CHANNEL_0
#define LEDC_MODE_LEFT_BACK      LEDC_HIGH_SPEED_MODE
#define LEDC_CHANNEL_RIGHT_BACK  LEDC_CHANNEL_1
#define LEDC_MODE_RIGHT_BACK     LEDC_HIGH_SPEED_MODE
#define LEDC_CHANNEL_LEFT_FRONT  LEDC_CHANNEL_2
#define LEDC_MODE_LEFT_FRONT     LEDC_LOW_SPEED_MODE
#define LEDC_CHANNEL_RIGHT_FRONT LEDC_CHANNEL_3
#define LEDC_MODE_RIGHT_FRONT    LEDC_LOW_SPEED_MODE
